...
public class AboutCasting {
    ...
    public void forceIntTypecast() {
        ...
        //casting it to int cause it to overflow
        int b = (int) a;
        assertEquals(b, Integer.MIN_VALUE);

        //casting a value within the range of int has no side effects
        long c = 32L;
        int d = (int) c;
        assertEquals(d, 32);
    }
    ...
    public void implicitTypecast() {
        ...
        //this also overflow, the addition occours before the assignment
        long c = a + b; 
