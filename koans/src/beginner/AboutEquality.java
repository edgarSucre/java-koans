...
public class AboutEquality {
    ...
    @Koan
    public void equalsMethodTestIfStringsHaveTheSameValue() {
      String name = "Edgar";
      String secondName = "Edgar";
      assertEquals(name.equals("Edgar"), true);
      assertEquals(name.equals(secondName), true);
    }
